  ...
  return (
    <div className='footer'>
      ...
      <div>
        <div id='socialIcons'>
          <a
            href='https://www.facebook.com/ShaunShinesDetailing/'
            target='_blank'
            rel='noreferrer'>
            <i className='bi bi-facebook'></i>
          </a>
          <a
            href='https://www.instagram.com/shaun_shines_detailing/'
            target='_blank'
            rel='noreferrer'>
            <i className='bi bi-instagram'></i>
          </a>
          <a
            href='https://www.youtube.com/ShaunShinesDetailing/'
            target='_blank'
            rel='noreferrer'>
            <i className='bi bi-youtube'></i>
          </a>
        </div>
        <div className='honoring-container'>
          <Image
            src={thoseWhoServe}
            alt='american flag'
            id='thoseWhoServe'
